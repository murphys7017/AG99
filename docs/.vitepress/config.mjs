            ...
            items: [
              {
                ...
                items: [
                  ...
                  { text: "Persona Effect", link: "/guides/persona-effects" },
                  { text: "Prompt Extension", link: "/guides/prompt-extensions" },
            ...
            items: [
              {
                ...
                items: [
                  ...
                  { text: "Persona Effects", link: "/guides/persona-effects" },
                  { text: "Prompt Extensions", link: "/guides/prompt-extensions" },
