...
CONFIG_METADATA_3 = {
    "ai_group": {
        ...
        "metadata": {
            "agent_runner": {
                "description": "普通对话 Agent Runner",
                "hint": "仅决定传统 Pipeline 普通对话是否整体交给第三方 Agent Runner。它不选择 Personal/Core 已委派任务的内部执行体。",
                "type": "object",
                "items": {
                    ...
                    "agent_runner.provider_id": {
                        "description": "第三方 Agent Runner 提供商 ID",
                        "type": "string",
                        "_special": "select_agent_runner_provider",
                        "provider_subtype_selector": "agent_runner.mode",
                        "condition": {
                            "agent_runner.mode": [
                                "dify",
                                "coze",
            ...
            "core_execution": {
                "description": "Core 内部执行体",
                "hint": "仅决定 Personal 委派后的 Core 执行体。它不替代普通对话的 Agent Runner。",
                "type": "object",
                "items": {
                    "core_execution.executor_id": {
                        ...
                        "labels": ["AstrBot 内置 Core", "Codex CLI"],
                        "condition": {
                            "provider_settings.enable": True,
                        },
                    },
                    "core_execution.codex_cli.provider_id": {
                        "description": "Codex CLI 执行体提供商 ID",
                        "type": "string",
                        "_special": "select_agent_runner_provider",
                        "provider_subtype_selector": "core_execution.executor_id",
                        "condition": {
            ...
            "plugin": {
                ...
                "items": {
                    ...
                    "interaction_middleware.contributor_timeout": {
                        ...
                        "type": "float",
                        "hint": "结果 Contributor 的单项时间上限；Prompt 收集统一使用插件上下文总预算。",
                    },
                    ...
                    "interaction_middleware.plugin_capability_targets": {
                        "description": "插件能力生效链路",
                        "type": "object",
                        "items": {},
                        "_special": "plugin_capability_target_map",
                        "hint": "按插件注册名称分别配置 llm_hooks 与 tools。tools 内具体工具名优先于 *；只影响 LLM Hook 和 FunctionTool，不改变 Handler、Prompt 或人格 Effect 的消费方。",
                    },
                },
            },
            "context": {
