"""Round-based utilities shared by context compaction."""
...
def split_into_rounds(contexts: Sequence[RoundSegment]) -> list[list[RoundSegment]]:
    """Split a flat context list into logical user-started rounds."""
...
def rounds_to_text(rounds: list[list[RoundSegment]]) -> str:
    """Render rounds into plain text for LLM summarisation."""
    lines: list[str] = []
