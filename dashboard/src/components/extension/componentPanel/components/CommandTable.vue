...
import { isPluginInactive } from '@/utils/commandState.mjs';
        ...
        <div class="d-flex align-center">
          <v-btn-group density="default" variant="text" color="primary">
            <span class="command-action-tooltip">
              ...
              <v-tooltip activator="parent" location="top">{{ isPluginInactive(item) ? tm('tooltips.pluginInactive') : (item.enabled ? tm('tooltips.disable') : tm('tooltips.enable')) }}</v-tooltip>
            </span>
