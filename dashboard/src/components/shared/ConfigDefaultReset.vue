...
<template>
  <div class="config-default-reset">
    ...
    <v-tooltip v-if="showReset" :text="t('core.common.restoreDefault')" location="top">
...
<style scoped>
.config-default-reset { display: flex; align-items: center; gap: 4px; width: 100%; }
.config-default-reset__field { flex: 1; min-width: 0; }
</style>
